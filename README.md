...
running command...
$ dutti-cli (--version)
dutti-cli-jolveragq/0.0.2 darwin-x64 node-v14.20.1
...
_See code: [dist/commands/create-branch.ts](https://github.com/jolveragq/hello-world/blob/v0.0.2/dist/commands/create-branch.ts)_
